...
internal sealed class TaskWorkloadImplWithState<TState>(TState _state, Func<TState, CancellationFlag, Task> _task, WorkloadStatus status, WorkloadContextOptions options, CancellationToken cancellationToken) 
