...
public sealed class ObjectPool<T> : IPool<T>, IDisposable where T : class, IPoolable<T>
{
    ...
    public T Rent()
    {
        ...
        DebugLog.WriteDiagnostic($"Renting a {typeof(T).Name} from the {nameof(ObjectPool<T>)}.");
    ...
    public bool Return(T item)
    {
        ...
        DebugLog.WriteDiagnostic($"Returning a {typeof(T).Name} to the {nameof(ObjectPool<T>)}.");
