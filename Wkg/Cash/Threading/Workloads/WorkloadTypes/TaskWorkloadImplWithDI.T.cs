...
internal sealed class TaskWorkloadImplWithDI<TResult>(Func<IWorkloadServiceProvider, CancellationFlag, Task<TResult>> _task, WorkloadStatus status, WorkloadContextOptions options, CancellationToken cancellationToken) 
