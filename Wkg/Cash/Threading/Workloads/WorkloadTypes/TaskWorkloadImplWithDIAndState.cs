...
internal sealed class TaskWorkloadImplWithDIAndState<TState>(TState _state, Func<TState, IWorkloadServiceProvider, CancellationFlag, Task> _task, WorkloadStatus status, WorkloadContextOptions options, CancellationToken cancellationToken) 
