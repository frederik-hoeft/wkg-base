...
internal sealed class TaskWorkloadImplWithDI(Func<IWorkloadServiceProvider, CancellationFlag, Task> _task, WorkloadStatus status, WorkloadContextOptions options, CancellationToken cancellationToken) 
