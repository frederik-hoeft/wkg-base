...
internal sealed class TaskWorkloadImplWithState<TState, TResult>(TState _state, Func<TState, CancellationFlag, Task<TResult>> _task, WorkloadStatus status, WorkloadContextOptions options, CancellationToken cancellationToken) 
